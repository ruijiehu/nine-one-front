  ...
  <el-card>
    ...
    <el-form label-width="100px">
      <el-form-item style="text-align: center;margin-left:-100px;margin-top:10px;">
        <el-button type="primary" v-if="activeName==='columnInfo'" icon="el-icon-plus"        @click="addColunm()">增加字段</el-button>
      </el-form-item>
      <el-form-item
  ...
  data() {
    return {
      ...
      info: {
        ...
        className: 'NewTable',
        functionAuthor: 'js',
        packageName: 'com.js.newtable',
        tplCategory: 'crud',
        functionName: 'newTableCrud',
        moduleName: 'newTableModule',
        businessName: 'newTableBiz'
      }
    }
  },
  created() {
