!(function (e, t) {
  ...
  var se,
    ...
    pe =
      ...
      function (e, t) {
        ...
        for (var L = 0; L < i; ++L)
          if (ce.test(o[L])) {
            for (var k = void 0, k = L + 1; k < i && ce.test(o[k]); ++k);
            for (
              var T = "L" == (L ? o[L - 1] : n),
        ...
        return (
          "ltr" == t &&
            (1 == A[0].level &&
              (O = e.match(/^\s+/)) &&
              ((A[0].from = O[0].length), A.unshift(new ge(0, 0, O[0].length))),
            1 == Y(A).level &&
              (O = e.match(/\s+$/)) &&
              ((Y(A).to -= O[0].length),
              A.push(new ge(0, i - O[0].length, i)))),
          "rtl" == t ? A.reverse() : A
        );
      });
  function ge(e, t, n) {
  ...
  var ve = [],
    ye = function (e, t, n) {
      e.addEventListener
        ...
        : ((e = e._handlers || (e._handlers = {}))[t] = (e[t] || ve).concat(n));
    };
  function be(e, t) {
  ...
  function we(e, t, n) {
    ...
    e.removeEventListener
      ...
      : !(e = (r = e._handlers) && r[t]) ||
        (-1 < (n = R(e, n)) && (r[t] = e.slice(0, n).concat(e.slice(n + 1))));
  }
  function xe(e, t) {
    var n = be(e, t);
    if (n.length)
  ...
  var Pe =
    ...
    Ie =
      "oncopy" in (r = M("div")) ||
      (r.setAttribute("oncopy", "return;"), "function" == typeof r.oncopy),
    Re = null;
  var ze = {},
    Be = {};
  function Ge(e) {
  ...
  function ct(e, t) {
    ...
    return t.line > n
      ? rt(n, $e(e, n).text.length)
      : ((e = $e(e, (n = t).line).text.length),
        null == (t = n.ch) || e < t
          ? rt(n.line, e)
          : t < 0
          ? rt(n.line, 0)
  ...
  (_e.prototype.eol = function () {
    ...
    (_e.prototype.indentation = function () {
      return (
        E(this.string, null, this.tabSize) -
        (this.lineStart ? E(this.string, this.lineStart, this.tabSize) : 0)
      );
    }),
  ...
  function mt(n, r, e) {
    var t = n.doc,
      i = n.display;
    if (!t.mode.startState) return new ft(t, !0, r);
    var o = (function (e, t, n) {
        for (
          ...
          if (
            u &&
            (!n || s + (u instanceof dt ? u.lookAhead : 0) <= o.modeFrontier)
          )
            return s;
      ...
      l = o > t.first && $e(t, o - 1).stateAfter,
  ...
  function vt(e, t, n, r) {
    var i = e.doc.mode,
      o = new _e(t, e.options.tabSize, n);
  ...
  (ft.prototype.lookAhead = function (e) {
    ...
    (ft.fromSaved = function (e, t, n) {
      return t instanceof dt
        ? new ft(e, je(e.mode, t.state), n, t.lookAhead)
  ...
  function xt(e, t, n, r) {
    var i,
      ...
      a = $e(l, (t = ct(l, t)).line),
      u = mt(e, t.line, n),
      c = new _e(a.text, e.options.tabSize, u);
    for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
      (c.start = c.pos),
        (i = bt(s, c, u.state)),
        r && o.push(new wt(c, i, je(l.mode, u.state)));
  ...
  function Nt(e, t) {
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            (!(
              ...
              (r = r || []).push(new Tt(s, l.from, o ? null : l.to)));
          }
        return r;
      })(n, i, e),
      s = (function (e, t, n) {
          ...
          for (var i = 0; i < e.length; ++i) {
            ...
            (!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) &&
              ...
              ((o =
                null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)),
              (r = r || []).push(
                new Tt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)
              ));
          }
        return r;
      })(r, o, e),
    ...
    if (s)
      for (var f = 0; f < s.length; ++f) {
        ...
        null != p.to && (p.to += u),
          null == p.from
            ? Mt(l, p.marker) || ((p.from = u), a && (l = l || []).push(p))
          ...
          if (
            ...
            (function e(t, n, r) {
              if (null == r.to) {
                ...
                return e(t, i.line, Mt(i.line.markedSpans, r.marker));
              }
  ...
  function jt(e) {
    var n = e.display,
      e = e.doc;
    (n.maxLine = $e(e, e.first)),
      (n.maxLineLength = Kt(n.maxLine)),
      (n.maxLineChanged = !0),
      e.iter(function (e) {
        var t = Kt(e);
  ...
  function qt(e, t) {
    var n = N("span", null, null, f ? "padding-right: .1px" : null),
      r = {
      ...
      (r.pos = 0),
        ...
        (function (e) {
          ...
          var t = T(e, document.createTextNode("AخA")),
            ...
            t = S(t, 1, 2).getBoundingClientRect();
          return k(e), n && n.left != n.right && (He = t.right - n.right < 3);
        })(e.display.measure) &&
        ...
        (function (e, t, n) {
          ...
          if (!r) {
            for (var l = 1; l < n.length; l += 2)
              t.addToken(t, i.slice(o, (o = n[l])), $t(n[l + 1], t.cm.options));
            return;
          }
          for (
            var s, a, u, c, h, d, f, p = i.length, g = 0, m = 1, v = "", y = 0;
            ;

          ) {
            if (y == g) {
              (u = c = h = a = ""), (d = f = null), (y = 1 / 0);
              for (var b = [], w = void 0, x = 0; x < r.length; ++x) {
                var C = r[x],
                  S = C.marker;
                if ("bookmark" == S.type && C.from == g && S.widgetNode)
                  b.push(S);
                else if (
                  C.from <= g &&
                  (null == C.to ||
                  ...
                  if (
                    ...
                    for (var L in S.attributes)
                      (f = f || {})[L] = S.attributes[L];
                  S.collapsed && (!d || Ft(d.marker, S) < 0) && (d = C);
              ...
              if (w)
                for (var k = 0; k < w.length; k += 2)
                  w[k + 1] == y && (c += " " + w[k]);
              if (!d || d.from == g)
                for (var T = 0; T < b.length; ++T) Jt(t, 0, b[T]);
              if (d && (d.from || 0) == g) {
                if (
                  (Jt(
                    t,
            ...
            if (p <= g) break;
            for (var M = Math.min(p, y); ; ) {
              if (v) {
                var N,
                  O = g + v.length;
                if (
                  (d ||
                    ((N = M < O ? v.slice(0, M - g) : v),
                    t.addToken(
                      t,
                      N,
                      s ? s + u : u,
              ...
              (v = i.slice(o, (o = n[m++]))), (s = $t(n[m++], t.cm.options));
            }
          }
        })(o, r, gt(e, o, t != e.display.externalMeasured && Je(o))),
        o.styleClasses &&
          (o.styleClasses.bgClass &&
            (r.bgClass = W(o.styleClasses.bgClass, r.bgClass || "")),
          o.styleClasses.textClass &&
            (r.textClass = W(o.styleClasses.textClass, r.textClass || ""))),
        0 == r.map.length &&
          r.map.push(
            0,
            0,
    ...
    return (
      ...
      xe(e, "renderLine", e, t.line, r.pre),
    ...
    if (t) {
      ...
      if (u.test(t)) {
        ...
        for (var h = 0; ; ) {
          ...
          if (
            (f &&
              ((p = document.createTextNode(a.slice(h, h + f))),
              w && v < 9 ? s.appendChild(M("span", [p])) : s.appendChild(p),
          ...
          "\t" == d[0]
            ? ((f = (f = e.cm.options.tabSize) - (e.col % f)),
              (p = s.appendChild(M("span", X(f), "cm-tab"))).setAttribute(
                "role",
                "presentation"
              ),
  ...
  function tn(e, t, n) {
    for (var r = [], i = t; i < n; i = l) {
      var o = new en(e.doc, $e(e.doc, i), i),
        l = i + o.size;
      r.push(o);
    }
    return r;
  ...
  function hn(e, t) {
    ...
    (n = e),
      (r = (i = t).bgClass
        ...
        : i.line.bgClass) && (r += " CodeMirror-linebackground"),
      i.background
        ? r
          ? (i.background.className = r)
  ...
  function fn(e, t, n) {
    if ((pn(e, t.line, t, n, !0), t.rest))
      for (var r = 0; r < t.rest.length; r++) pn(e, t.rest[r], t, n, !1);
  }
  function pn(e, t, n, r, i) {
    if (t.widgets)
      for (var o = un(n), l = 0, s = t.widgets; l < s.length; ++l) {
        var a = s[l],
          u = M(
            "div",
            [a.node],
  ...
  function bn(e) {
    ...
    var t = T(e.measure, M("pre", "x", "CodeMirror-line-like")),
  ...
  function Tn(e, t) {
    ...
    o && !o.text
      ? (o = null)
      : o && o.changes && (an(e, o, i, $n(e)), (e.curOp.forceUpdate = !0)),
      o ||
        ((n = e),
        (e = Je((r = zt((r = t))))),
        ((r = n.display.externalMeasured = new en(n.doc, r, e)).lineN = e),
        (e = r.built = qt(n, r)),
        (r.text = e.pre),
        T(n.display.lineMeasure, e.pre),
        (o = r));
    i = Sn(o, t, i);
    return {
      line: t,
            ...
            ((function (e, t, n) {
              ...
              if (!t.measure.heights || (r && t.measure.width != e)) {
                ...
                if (r) {
                  t.measure.width = e;
                  for (
                    var o = t.text.firstChild.getClientRects(), l = 0;
                    l < o.length - 1;
                    l++
                  ) {
                    var s = o[l],
                      a = o[l + 1];
                    2 < Math.abs(s.bottom - a.bottom) &&
                      i.push((s.bottom + a.top) / 2 - n.top);
                  }
                }
            ...
            if (3 == l.nodeType) {
              for (var c = 0; c < 4; c++) {
                ...
                for (
                  ...
                  ne(t.line.text.charAt(o.coverStart + a));
                  ...
                  if (
                    ...
                    !(function (e) {
                      ...
                      var e = (t = T(
                        ...
                        t = S(t, 0, 1).getBoundingClientRect();
              ...
              0 < s && (u = r = "right"),
                (i =
                  e.options.lineWrapping && 1 < (g = l.getClientRects()).length
                    ? g["right" == r ? g.length - 1 : 0]
                    : l.getBoundingClientRect());
            !(w && v < 9) ||
              s ||
              (i && (i.left || i.right)) ||
              ((m = l.parentNode.getClientRects()[0]),
              (i = m
                ? {
                    left: m.left,
  ...
  function Wn(e) {
    ...
    for (var t = 0; t < e.display.view.length; t++) Dn(e.display.view[t]);
  }
  function Hn(e) {
    Wn(e),
  ...
  function In(e, t, n, r, i) {
    ...
    t = Vt(t);
    return (
      "local" == r ? (t += vn(e.display)) : (t -= e.display.viewOffset),
      ("page" != r && "window" != r) ||
        ((t +=
          (e = e.display.lineSpace.getBoundingClientRect()).top +
          ("window" == r ? 0 : Pn())),
        (r = e.left + ("window" == r ? 0 : Fn())),
        (n.left += r),
        (n.right += r)),
      (n.top += t),
      (n.bottom += t),
  ...
  function Bn(n, e, r, i, o, l) {
    ...
    var a = me(i, n.doc.direction),
      t = e.ch,
      u = e.sticky;
    if (
      (t >= i.text.length
        ? ((t = i.text.length), (u = "before"))
        : t <= 0 && ((t = 0), (u = "after")),
      !a)
    )
  ...
  function Vn(e, t, n) {
    var r = e.doc;
    if ((n += e.display.viewOffset) < 0) return Un(r.first, 0, null, -1, -1);
    var i = et(r, n),
      o = r.first + r.size - 1;
    if (o < i)
      return Un(r.first + r.size - 1, $e(r, o).text.length, null, 1, 1);
    t < 0 && (t = 0);
    for (var l = $e(r, i); ; ) {
                    ...
                    for (var u = null, c = null, h = 0; h < i.length; h++) {
                      ...
                      f.from >= a ||
                        ...
                        (d = Mn(
                          e,
                          r,
                          d ? Math.min(a, f.to) - 1 : Math.max(s, f.from)
                        ).right),
                        (d = d < o ? o - d + 1e9 : d - o),
                        (!u || d < c) && ((u = f), (c = d)));
                    }
            ...
            d
              ...
              : (u || (c != a && c != s) || c++,
                (g =
                  0 == c ||
                  (c != e.text.length &&
                    Mn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u)
                    ? "after"
                    : "before"),
                (u = Bn(n, rt(t, c, g), "line", e, o)),
                (p = u.left),
  ...
  function Yn(e) {
    ...
    return 3 < n && (e.cachedTextHeight = n), k(e.measure), n || 1;
  }
  function _n(e) {
  ...
  function Jn(e, t, n, r) {
    ...
    return (
      r &&
        0 < i.xRel &&
        (a = $e(e.doc, i.line).text).length == i.ch &&
        ((a = E(a, a.length, e.options.tabSize) - a.length),
        (i = rt(
          i.line,
          Math.max(0, Math.round((o - bn(e.display).left) / _n(e.display)) - a)
        ))),
      i
    );
  }
  ...
  function tr(e, t, n, r) {
    ...
    r &&
      n < l.viewTo &&
      (null == l.updateLineNumbers || l.updateLineNumbers > t) &&
      (l.updateLineNumbers = t),
      (e.curOp.viewChanged = !0),
      t >= l.viewTo
        ? kt && Bt(e.doc, t) < l.viewTo && rr(e)
        : n <= l.viewFrom
        ? kt && Gt(e.doc, n + r) > l.viewFrom
          ? rr(e)
          : ((l.viewFrom += r), (l.viewTo += r))
        : t <= l.viewFrom && n >= l.viewTo
        ? rr(e)
        : t <= l.viewFrom
        ? (i = ir(e, n, n + r, 1))
          ? ((l.view = l.view.slice(i.index)),
            (l.viewFrom = i.lineN),
            (l.viewTo += r))
          : rr(e)
        : n >= l.viewTo
        ? (o = ir(e, t, t, -1))
          ? ((l.view = l.view.slice(0, o.index)), (l.viewTo = o.lineN))
          : rr(e)
        : ((i = ir(e, t, t, -1)),
          (o = ir(e, n, n + r, 1)),
          i && o
            ? ((l.view = l.view
                .slice(0, i.index)
                .concat(tn(e, i.lineN, o.lineN))
                .concat(l.view.slice(o.index))),
              (l.viewTo += r))
            : rr(e));
    ...
    e &&
      (n < e.lineN
        ? (e.lineN += r)
        : t < e.lineN + e.size && (l.externalMeasured = null));
  }
  function nr(e, t, n) {
    e.curOp.viewChanged = !0;
    var r = e.display,
    ...
    i && t >= i.lineN && t < i.lineN + i.size && (r.externalMeasured = null),
      t < r.viewFrom ||
        t >= r.viewTo ||
        null == (t = r.view[er(e, t)]).node ||
        (-1 == R((t = t.changes || (t.changes = [])), n) && t.push(n));
  }
  function rr(e) {
  ...
  function sr(e, t) {
    ...
    for (
      var n,
        ...
        s = (o.selection = document.createDocumentFragment()),
        a = 0;
      a < i.sel.ranges.length;
      a++
    )
      (!t && a == i.sel.primIndex) ||
        (n = i.sel.ranges[a]).from().line >= e.display.viewTo ||
        n.to().line < e.display.viewFrom ||
        (((r = n.empty()) || e.options.showCursorWhenSelecting) &&
          ar(e, n.head, l),
        r ||
          (function (i, e, t) {
            var n = i.display,
              ...
              r = bn(i.display),
              S = r.left,
              L = Math.max(n.sizerWidth, xn(i) - n.sizer.offsetLeft) - r.right,
              k = "ltr" == o.direction;
            function T(e, t, n, r) {
              t < 0 && (t = 0),
                (t = Math.round(t)),
            ...
            function s(n, g, m) {
              ...
              return (
                (function (e, t, n, r) {
                  ...
                  c.top - u.top <= 3
                    ? ((i = (k ? d : h) && p),
                      (r = (k ? h : d) && f ? S : (a ? u : c).left),
                      (i = i ? L : (a ? c : u).right),
                      T(r, u.top, i - r, u.bottom))
                    : ((n = a
                        ? ((o = k && h && f ? S : u.left),
                          (l = k ? L : x(e, n, "before")),
                          (s = k ? S : x(t, n, "after")),
            ...
            a.line == n.line
              ...
              : ((r = $e(o, a.line)),
                ...
                e &&
                  (r.top < n.top - 2
                    ? (T(r.right, r.top, null, r.bottom),
                      T(S, n.top, n.left, n.bottom))
                    : T(r.right, r.top, n.left - r.right, r.bottom)),
  ...
  function ar(e, t, n) {
    var r = Bn(e, t, "div", null, null, !e.options.singleCursorHeightPerLine),
    ...
    (t.style.left = r.left + "px"),
      ...
      r.other &&
        ...
        (n.style.height = 0.85 * (r.other.bottom - r.other.top) + "px"));
  }
  function ur(e, t) {
  ...
  function gr(e) {
    for (
      ...
      if (!o.hidden) {
        w && v < 8
          ? ((s = (i = o.node.offsetTop + o.node.offsetHeight) - n), (n = i))
          : ((s = (u = o.node.getBoundingClientRect()).bottom - u.top),
            !l &&
              o.text.firstChild &&
              (a =
                o.text.firstChild.getBoundingClientRect().right - u.left - 1));
        var u = o.line.height - s;
        if ((0.005 < u || u < -0.005) && (Qe(o.line, s), mr(o.line), o.rest))
          for (var c = 0; c < o.rest.length; c++) mr(o.rest[c]);
        a > e.display.sizerWidth &&
          (a = Math.ceil(a / _n(e.display))) > e.display.maxLineLength &&
  ...
  function vr(e, t, n) {
    ...
    return (
      n &&
        n.ensure &&
        ((i = n.ensure.from.line),
        (n = n.ensure.to.line),
        i < o
          ? (r = et(t, Vt($e(t, (o = i))) + e.wrapper.clientHeight))
          : Math.min(n, t.lastLine()) >= r &&
            ((o = et(t, Vt($e(t, n)) - e.wrapper.clientHeight)), (r = n))),
      { from: o, to: Math.max(r, o + 1) }
    );
  }
  function yr(e, t) {
    var n = e.display,
      r = Yn(e.display);
    t.top < 0 && (t.top = 0);
    var i = (e.curOp && null != e.curOp.scrollTop ? e.curOp : n.scroller)
        .scrollTop,
      o = Cn(e),
      l = {};
    t.bottom - t.top > o && (t.bottom = t.top + o);
    var s = e.doc.height + yn(n),
      a = t.top < r,
      r = t.bottom > s - r;
    t.top < i
    ...
    return (
      ...
      t.left < 10
        ? (l.scrollLeft = 0)
        : t.left < u
        ? (l.scrollLeft = Math.max(0, t.left + i - (n ? 0 : 10)))
        : t.right > e + u - 3 && (l.scrollLeft = t.right + (n ? 0 : 10) - e),
      l
    );
  }
  function br(e, t) {
  ...
  function Cr(e) {
    ...
    t &&
      ...
      Sr(e, Gn(e, t.from), Gn(e, t.to), t.margin));
  }
  function Sr(e, t, n, r) {
    r = yr(e, {
  ...
  function Lr(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (d || Kr(e, { top: t }), kr(e, t, !0), d && Kr(e), zr(e, 100));
  }
  function kr(e, t, n) {
    (t = Math.max(
      0,
  ...
  function Dr(n) {
    n.display.scrollbars &&
      ...
      n.display.scrollbars.addClass &&
        L(n.display.wrapper, n.display.scrollbars.addClass)),
      (n.display.scrollbars = new Ar[n.options.scrollbarStyle](
        function (e) {
          n.display.wrapper.insertBefore(e, n.display.scrollbarFiller),
            ye(e, "mousedown", function () {
              n.state.focused &&
                setTimeout(function () {
      ...
      n.display.scrollbars.addClass &&
        D(n.display.wrapper, n.display.scrollbars.addClass);
  }
  var Wr = 0;
  function Hr(e) {
    (e.curOp = {
      ...
      nn
        ? nn.ops.push(e)
        : (e.ownsGroup = nn = { ops: [e], delayedCallbacks: [] });
  }
  function Fr(e) {
    e = e.curOp;
    e &&
            ...
            !(function (e) {
              ...
              if (o)
                for (var s = 0; s < o.length; ++s)
                  o[s].lines.length || xe(o[s], "hide");
              if (l)
                for (var a = 0; a < l.length; ++a)
                  l[a].lines.length && xe(l[a], "unhide");
  ...
  function zr(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, F(Br, e));
  }
  function Br(l) {
    var s,
      a,
      ...
      c.iter(
        ...
        function (e) {
          if (a.line >= l.display.viewFrom) {
            ...
            e.text.length <= l.options.maxHighlightLength && vt(l, e.text, a),
  ...
  function Ur(e, t) {
    ...
    (r = o),
      (i = l),
      0 == (l = (o = e).display).view.length || r >= l.viewTo || i <= l.viewFrom
        ? ((l.view = tn(o, r, i)), (l.viewFrom = r))
        : (l.viewFrom > r
            ? (l.view = tn(o, r, l.viewFrom).concat(l.view))
            : l.viewFrom < r && (l.view = l.view.slice(er(o, r))),
          (l.viewFrom = r),
          l.viewTo < i
            ? (l.view = l.view.concat(tn(o, l.viewTo, i)))
            : l.viewTo > i && (l.view = l.view.slice(0, er(o, i)))),
      (l.viewTo = i),
      (n.viewOffset = Vt($e(e.doc, n.viewFrom))),
      ...
      return (
        !window.getSelection ||
          ((t = window.getSelection()).anchorNode &&
            t.extend &&
            O(e.display.lineDiv, t.anchorNode) &&
    ...
    return (
      4 < o && (n.lineDiv.style.display = "none"),
      (function (n, e, t) {
        var r = n.display,
        ...
        function s(e) {
          var t = e.nextSibling;
          return (
            f && g && n.display.currentWheelTarget == e
        ...
        for (var a = r.view, u = r.viewFrom, c = 0; c < a.length; c++) {
          ...
          if (!h.hidden)
            if (h.node && h.node.parentNode == o) {
              ...
              h.changes &&
                (-1 < R(h.changes, "gutter") && (d = !1), an(n, h, u, t)),
                d &&
                  (k(h.lineNumber),
                  h.lineNumber.appendChild(
                    document.createTextNode(nt(n.options, u))
                  )),
      ...
      (i = l) &&
        ...
        i.activeElt != A() &&
        (i.activeElt.focus(),
        !/^(INPUT|TEXTAREA)$/.test(i.activeElt.nodeName) &&
          i.anchorNode &&
          O(document.body, i.anchorNode) &&
          O(document.body, i.focusNode) &&
  ...
  function Vr(e, t) {
    for (var n = t.viewport, r = !0; ; r = !1) {
      if (r && e.options.lineWrapping && t.oldDisplayWidth != xn(e))
        ...
        (n &&
          null != n.top &&
          (n = { top: Math.min(e.doc.height + yn(e.display) - Cn(e), n.top) }),
  ...
  function Kr(e, t) {
    var n = new Gr(e, t);
    Ur(e, n) &&
      (gr(e), Vr(e, n), (t = Mr(e)), lr(e), Nr(e, t), Xr(e, t), n.finish());
  }
  function jr(e) {
  ...
  function Yr(e) {
    ...
    if (t.alignWidgets || (t.gutters.firstChild && e.options.fixedGutter)) {
      for (
        var r = qn(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
  ...
  function ri(e, t) {
    ...
    if ((r && s) || (i && a)) {
      ...
      if (r && !d && !p && null != ei)
        return (
          i && a && Lr(e, Math.max(0, l.scrollTop + i * ei)),
          Tr(e, Math.max(0, l.scrollLeft + r * ei)),
          (!i || (i && a)) && Te(t),
      ...
      i &&
        ...
        n < 0
          ? (s = Math.max(0, s + n - 50))
          : (a = Math.min(e.doc.height, a + n + 50)),
        Kr(e, { top: s, bottom: a })),
        Jr < 20 &&
          (null == o.wheelStartX
            ? ((o.wheelStartX = l.scrollLeft),
              ...
              setTimeout(function () {
                var e, t;
                null != o.wheelStartX &&
                  ((t = l.scrollLeft - o.wheelStartX),
                  (t =
                    ((e = l.scrollTop - o.wheelStartY) &&
                      o.wheelDY &&
                      e / o.wheelDY) ||
                    (t && o.wheelDX && t / o.wheelDX)),
                  (o.wheelStartX = o.wheelStartY = null),
                  t && ((ei = (ei * Jr + t) / (Jr + 1)), ++Jr));
              }, 200))
            : ((o.wheelDX += r), (o.wheelDY += i)));
    }
  }
  w ? (ei = -0.53) : d ? (ei = 15) : o ? (ei = -0.7) : c && (ei = -1 / 3);
  var ii = function (e, t) {
  ...
  (ii.prototype.primary = function () {
    ...
    (ii.prototype.deepCopy = function () {
      for (var e = [], t = 0; t < this.ranges.length; t++)
        e[t] = new oi(lt(this.ranges[t].anchor), lt(this.ranges[t].head));
  ...
  function hi(e, t, n) {
    return e.line == t.line
      ? rt(n.line, e.ch - t.ch + n.ch)
      : rt(n.line + (e.line - t.line), e.ch);
  }
  function di(e) {
  ...
  function gi(e, o, t, l) {
    ...
    function n(e, t, n) {
      ...
      (r = t),
        ...
        At(n),
        Dt(n, i),
        (t = t ? t(n) : 1) != n.height && Qe(n, t),
        ln(e, "change", e, o);
    }
    function r(e, t) {
      for (var n = [], r = e; r < t; ++r) n.push(new Xt(c[r], i(r), l));
      return n;
    }
    var s,
      a = o.from,
    ...
    o.full
      ...
      ? 1 == c.length
        ...
        : ((s = r(1, c.length - 1)).push(new Xt(f + h.text.slice(u.ch), p, l)),
  ...
  function wi(e, t) {
    ...
    return (
      ki(e, n, t.from.line, t.to.line + 1),
      mi(
        e,
        function (e) {
  ...
  function Ci(e, t, n, r) {
    ...
    if (
      ...
      (l = Y(o.changes)),
        0 == it(t.from, t.to) && 0 == it(t.from, l.to)
          ? (l.to = ai(t))
          : o.changes.push(wi(e, t));
    else {
      var a = Y(i.done);
      for (
        (a && a.ranges) || Li(e.sel, i.done),
          o = { changes: [wi(e, t)], generation: i.generation },
          i.done.push(o);
  ...
  function Si(e, t, n, r) {
    ...
    (a &&
      ...
      ((s.lastModTime == s.lastSelTime && s.lastOrigin == a) ||
        ...
        "*" == (o = o.charAt(0)) ||
          ("+" == o &&
            l.ranges.length == e.ranges.length &&
            l.somethingSelected() == e.somethingSelected() &&
  ...
  function Ei(e, t, n) {
    var r, i;
    (Le(e, "beforeSelectionChange") ||
      (e.cm && Le(e.cm, "beforeSelectionChange"))) &&
      ((r = e),
      (i = n),
      (i = {
        ranges: (o = t).ranges,
        update: function (e) {
          this.ranges = [];
          for (var t = 0; t < e.length; t++)
            this.ranges[t] = new oi(ct(r, e[t].anchor), ct(r, e[t].head));
        },
        origin: i && i.origin,
      }),
      xe(r, "beforeSelectionChange", r, i),
      r.cm && xe(r.cm, "beforeSelectionChange", r.cm, i),
      (t = i.ranges != o.ranges ? li(r.cm, i.ranges, i.ranges.length - 1) : o));
    var o =
      (n && n.bias) ||
      (it(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
    Ii(e, zi(e, t, o, !0)), (n && !1 === n.scroll) || !e.cm || wr(e.cm);
  }
  function Ii(e, t) {
    t.equals(e.sel) ||
      ((e.sel = t),
  ...
  function zi(e, t, n, r) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      ...
      (!i && a == l.anchor && s == l.head) ||
        ((i = i || t.ranges.slice(0, o))[o] = new oi(a, s));
    }
        ...
        if (
          ...
          if (a.atomic) {
            if (n) {
              ...
              if (
                ((r < 0 ? c : u) &&
                  (h = Ui(e, h, -r, h && h.line == t.line ? o : null)),
                h &&
                  h.line == t.line &&
                  (s = it(h, n)) &&
                  (r < 0 ? s < 0 : 0 < s))
            ...
            a = a.find(r < 0 ? -1 : 1);
            return (
              (r < 0 ? u : c) && (a = Ui(e, a, r, a.line == t.line ? o : null)),
              a ? Bi(e, a, t, r, i) : null
            );
          }
        }
  ...
  function Ui(e, t, n, r) {
    return n < 0 && 0 == t.ch
      ? t.line > e.first
        ? ct(e, rt(t.line - 1))
        : null
      : 0 < n && t.ch == (r || $e(e, t.line)).text.length
      ? t.line < e.first + e.size - 1
        ? rt(t.line + 1, 0)
        : null
      : new rt(t.line, t.ch + n);
  }
  function Vi(e) {
  ...
  function Ki(i, e, t) {
    ...
    return (
      ...
      xe(i, "beforeChange", i, o),
      i.cm && xe(i.cm, "beforeChange", i.cm, o),
      o.canceled
  ...
  function ji(e, t, n) {
    if (e.cm) {
      if (!e.cm.curOp) return Er(e.cm, ji)(e, t, n);
  ...
  function Xi(e, n) {
    ...
    (1 == n.text.length && "" == n.text[0] && 0 == it(n.from, n.to)) ||
      ...
      (r = []),
      mi(e, function (e, t) {
        t || -1 != R(r, e.history) || (Ji(e.history, n), r.push(e.history)),
          $i(e, n, null, Nt(e, n));
      }));
  }
  function Yi(i, o, e) {
      ...
      if (u != s.length) {
        for (n.lastOrigin = n.lastSelOrigin = null; ; ) {
          ...
          if ((Li(l, a), e && !l.equals(i.sel)))
            return void Pi(i, l, { clearRedo: !1 });
          r = l;
        }
        var c = [];
        Li(r, a),
        ...
        for (
          var h = Le(i, "beforeChange") || (i.cm && Le(i.cm, "beforeChange")),
          ...
          var f = (function (e) {
            var n = l.changes[e];
            if (((n.origin = o), h && !Ki(i, n, !1))) return (s.length = 0), {};
            c.push(wi(i, n));
            var t = e ? ci(i, n) : Y(s);
            $i(i, n, t, Mi(i, n)),
              !e && i.cm && i.cm.scrollIntoView({ from: n.from, to: ai(n) });
            var r = [];
            mi(i, function (e, t) {
              t ||
                -1 != R(r, e.history) ||
                (Ji(e.history, n), r.push(e.history)),
                $i(e, n, null, Mi(e, n));
            });
          })(d);
          if (f) return f.v;
  ...
  function $i(e, t, n, r) {
    if (e.cm && !e.cm.curOp) return Er(e.cm, $i)(e, t, n, r);
    var i;
    t.to.line < e.first
      ? _i(e, t.text.length - 1 - (t.to.line - t.from.line))
      : t.from.line > e.lastLine() ||
        (t.from.line < e.first &&
          (_i(e, (i = t.text.length - 1 - (e.first - t.from.line))),
          (t = {
            from: rt(e.first, 0),
        ...
        e.cm
          ? (function (e, t, n) {
              ...
              t.full
                ? tr(e)
                : o.line != l.line || 1 != t.text.length || pi(e.doc, t)
                ? tr(e, o.line, l.line + 1, a)
                : nr(e, o.line, "text");
          ...
          : gi(e, t, r),
        Ei(e, n, G),
        e.cantEdit && Gi(e, rt(e.firstLine(), 0)) && (e.cantEdit = !1));
  }
  function qi(e, t, n, r, i) {
    var o;
    it((r = r || n), n) < 0 && ((n = (o = [r, n])[0]), (r = o[1])),
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.ranges.length; s++)
          Zi(o.ranges[s].anchor, t, n, r), Zi(o.ranges[s].head, t, n, r);
      } else {
        for (var a = 0; a < o.changes.length; ++a) {
          var u = o.changes[a];
          if (n < u.from.line)
            (u.from = rt(u.from.line + r, u.from.ch)),
              (u.to = rt(u.to.line + r, u.to.ch));
          else if (t <= u.to.line) {
            l = !1;
            break;
          }
  ...
  function eo(e, t, n, r) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = $e(e, ut(e, t))) : (i = Je(t)),
      null == i ? null : (r(o, i) && e.cm && nr(e.cm, i, n), o)
    );
  }
  function to(e) {
  ...
  (oi.prototype.from = function () {
    ...
    (no.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        this.size - t < 25 &&
          (1 < this.children.length || !(this.children[0] instanceof to)) &&
          ((n = []),
          this.collapse(n),
        ...
        if (!(this.children.length <= 10)) {
          ...
          do {
            ...
            (e.parent
              ...
              : ((((t = new no(e.children)).parent = e).children = [t, n]),
                (e = t)),
            (n.parent = e.parent),
  ...
  function so(t, n, r, e, i) {
    ...
    if (t.cm && !t.cm.curOp) return Er(t.cm, so)(t, n, r, e, i);
    var o = new lo(t, i),
      i = it(n, r);
    if ((e && P(e, o, !1), 0 < i || (0 == i && !1 !== o.clearWhenEmpty)))
      return o;
    if (
      (o.replacedWith &&
        ((o.collapsed = !0),
      ...
      if (
        Rt(t, n.line, n, r, o) ||
        (n.line != r.line && Rt(t, r.line, n, r, o))
      )
        throw new Error(
    ...
    var l,
      ...
      a = t.cm;
    if (
      (t.iter(s, r.line + 1, function (e) {
        var t;
        a &&
          o.collapsed &&
          !a.options.lineWrapping &&
          zt(e) == a.display.maxLine &&
          (l = !0),
          o.collapsed && s != n.line && Qe(e, 0),
          (t = e),
          (e = new Tt(o, s == n.line ? n.ch : null, s == r.line ? r.ch : null)),
          (t.markedSpans = t.markedSpans ? t.markedSpans.concat([e]) : [e]),
          e.marker.attachLine(t),
          ++s;
      }),
      o.collapsed &&
        t.iter(n.line, r.line + 1, function (e) {
          Ut(t, e) && Qe(e, 0);
        }),
      o.clearOnEnter &&
        ye(o, "beforeCursorEnter", function () {
          return o.clear();
        }),
      o.readOnly &&
        ((Lt = !0),
      ...
      if ((l && (a.curOp.updateMaxLine = !0), o.collapsed))
        tr(a, n.line, r.line + 1);
      else if (
        o.className ||
        o.startStyle ||
        o.endStyle ||
        ...
        for (var u = n.line; u <= r.line; u++) nr(a, u, "text");
  ...
  (lo.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      ...
      n && Hr(t),
        !Le(this, "clear") ||
          ((e = this.find()) && ln(this, "clear", e.from, e.to));
      for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
        var l = this.lines[o],
          s = Mt(l.markedSpans, this);
        t && !this.collapsed
          ? nr(t, Je(l), "text")
          : t && (null != s.to && (i = Je(l)), null != s.from && (r = Je(l))),
      ...
      null != r && t && this.collapsed && tr(t, r, i + 1),
        ...
        this.atomic &&
          this.doc.cantEdit &&
          ((this.doc.cantEdit = !1), t && Ri(t.doc)),
        t && ln(t, "markerCleared", t, this, r, i),
        n && Fr(t),
    ...
    (lo.prototype.find = function (e, t) {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        var o = this.lines[i],
          l = Mt(o.markedSpans, this);
        if (null != l.from && ((n = rt(t ? o : Je(o), l.from)), -1 == e))
          return n;
      ...
      r &&
        ...
        Pr(o, function () {
          var e = r.line,
            t = Je(r.line),
            t = kn(o, t);
          t && (Dn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
            (o.curOp.updateMaxLine = !0),
            Ut(i.doc, e) ||
              null == i.height ||
              ((t = i.height),
              (i.height = null),
              (t = gn(i) - t) && Qe(e, e.height + t)),
  ...
  var co = 0,
    ho = function (e, t, n, r, i) {
      ...
      null == n && (n = 0),
        no.call(this, [new to([new Xt("", null)])]),
        (this.first = n),
  ...
  (ho.prototype = q(no.prototype, {
    ...
    setCursor: Rr(function (e, t, n) {
      Hi(this, ct(this, "number" == typeof e ? rt(e, t || 0) : e), null, n);
    }),
    ...
    setSelections: Rr(function (e, t, n) {
      if (e.length) {
        for (var r = [], i = 0; i < e.length; i++)
          r[i] = new oi(ct(this, e[i].anchor), ct(this, e[i].head));
    ...
    addSelection: Rr(function (e, t, n) {
      ...
      r.push(new oi(ct(this, e), ct(this, t || e))),
        Pi(this, li(this.cm, r, r.length - 1), n);
    }),
    getSelection: function (e) {
      for (var t = this.sel.ranges, n = 0; n < t.length; n++)
        var r = qe(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r;
            ...
            (function (e, t, n) {
              for (
                ...
                var l = t[o],
                  ...
                  i = a;
                "around" == n
                  ? ((l = it((l = e.sel.ranges[o]).head, l.anchor) < 0),
                    (r[o] = new oi(l ? a : s, l ? s : a)))
                  : (r[o] = new oi(s, s));
              }
    ...
    addLineWidget: Rr(function (e, t, n) {
      return (
        ...
        o && ln(o, "lineWidgetAdded", o, i, "number" == typeof e ? e : Je(e)),
        i
      );
      var r, i, o;
    }),
    ...
    findMarksAt: function (e) {
      var t = [],
        n = $e(this, (e = ct(this, e)).line).markedSpans;
      if (n)
        for (var r = 0; r < n.length; ++r) {
          var i = n[r];
    ...
    copy: function (e) {
      var t = new ho(
        Ze(this, this.first, this.first + this.size),
        this.modeOption,
        this.first,
        this.lineSep,
        this.direction
    ...
    linkedDoc: function (e) {
      ...
      return (
        e.sharedHist && (t.history = this.history),
        (this.linked || (this.linked = [])).push({
          doc: t,
          sharedHist: e.sharedHist,
        }),
        (t.linked = [{ doc: this, isParent: !0, sharedHist: e.sharedHist }]),
        (function (e, t) {
          for (var n = 0; n < t.length; n++) {
            var r = t[n],
              i = r.find(),
              ...
              i = e.clipPos(i.to);
            it(o, i) &&
              ((i = so(e, o, i, r.primary, r.primary.type)),
              r.markers.push(i),
              (i.parent = r));
          }
        })(t, uo(this)),
    ...
    unlinkDoc: function (e) {
      if ((e instanceof ul && (e = e.doc), this.linked))
        ...
        if (n && n.length && window.FileReader && window.File)
          for (
              ...
              s = function () {
                ++l == i &&
                  Er(r, function () {
                    ...
                    ji(r.doc, e), Fi(r.doc, si(ct(r.doc, t), ct(r.doc, ai(e))));
                  })();
              },
              a = 0;
            a < n.length;
            ...
            !(function (e, t) {
              ...
              -1 == R(r.options.allowDropFileTypes, e.type)
                ? s()
                : (((n = new FileReader()).onerror = s),
                  (n.onload = function () {
                    var e = n.result;
    ...
    for (t in e)
      if (e.hasOwnProperty(t)) {
        ...
        if (!/^(name|fallthrough|(de|at)tach)$/.test(t))
          if ("..." != i) {
            for (var o = _(t.split(" "), ko), l = 0; l < o.length; l++) {
              var s = void 0,
                a = void 0,
                s =
                  l == o.length - 1
  ...
  function Mo(e, t, n, r) {
    var i = (t = Do(t)).call ? t.call(e, r) : t[e];
    if (!1 === i) return "nothing";
    if ("..." === i) return "multi";
    if (null != i && n(i)) return "handled";
    if (t.fallthrough) {
      if ("[object Array]" != Object.prototype.toString.call(t.fallthrough))
        return Mo(e, t.fallthrough, n, r);
      for (var o = 0; o < t.fallthrough.length; o++) {
        var l = Mo(e, t.fallthrough[o], n, r);
        if (l) return l;
      }
    }
  }
  ...
  function Ao(e, t) {
    ...
    return (
      null != n &&
      !e.altGraphKey &&
      (3 == e.keyCode && e.code && (n = e.code), Oo(n, e, t))
    );
  }
  function Do(e) {
  ...
  function Eo(t, n, s, e) {
    ...
    if (
      ...
      return Fo(n, s, e);
    function u(e, t) {
      return Ho(n, e instanceof rt ? e.ch : e, t);
    }
    function o(e) {
      return t.options.lineWrapping
        ? ((l = l || Tn(t, n)), jn(t, n, l, e))
    ...
    (f = function (e, t, n) {
      for (
        var r = function (e, t) {
          return t
            ? new rt(s.line, u(e, 1), "before")
            : new rt(s.line, e, "after");
        };
        0 <= e && e < a.length;
        e += t
      ) {
  ...
  (Lo.basic = {
    ...
    (Lo.default = g ? Lo.macDefault : Lo.pcDefault);
  var Io = {
    selectAll: Vi,
    ...
    transposeChars: function (l) {
      return Pr(l, function () {
        for (
          ...
          r[o].empty() &&
            ((e = r[o].head),
            (t = $e(l.doc, e.line).text) &&
              (e.ch == t.length && (e = new rt(e.line, e.ch - 1)),
              0 < e.ch
                ? ((e = new rt(e.line, e.ch + 1)),
                  l.replaceRange(
                ...
                : e.line > l.doc.first &&
                  (n = $e(l.doc, e.line - 1).text) &&
                  ((e = new rt(e.line, 1)),
                  l.replaceRange(
                    t.charAt(0) +
                      l.doc.lineSeparator() +
                      n.charAt(n.length - 1),
                    rt(e.line - 1, n.length - 1),
                    e,
                    "+transpose"
                  ))),
            i.push(new oi(e, e)));
    ...
    newlineAndIndent: function (r) {
      return Pr(r, function () {
        for (var e = r.listSelections(), t = e.length - 1; 0 <= t; t--)
          r.replaceRange(
            r.doc.lineSeparator(),
            e[t].anchor,
            e[t].head,
        ...
        e = r.listSelections();
        for (var n = 0; n < e.length; n++)
          r.indentLine(e[n].from().line, null, !0);
        wr(r);
      });
    },
    openLine: function (e) {
  ...
  function Ro(e, t) {
    var n = $e(e.doc, t),
      r = zt(n);
    return r != n && (t = Je(r)), Po(!0, e, r, t, 1);
  }
  function zo(e, t) {
    var n = Ro(e, t.line),
      r = $e(e.doc, n.line),
  ...
  function Vo(e, t, n, r) {
    r = (function (e, t, n) {
      for (var r = 0; r < e.state.keyMaps.length; r++) {
        var i = Mo(t, e.state.keyMaps[r], n, e);
        if (i) return i;
      }
      return (
        (e.options.extraKeys && Mo(t, e.options.extraKeys, n, e)) ||
        Mo(t, e.options.keyMap, n, e)
      );
    })(e, t, r);
    return (
      "multi" == r && (e.state.keySeq = t),
      "handled" == r && ln(e, "keyHandled", e, t, n),
      ("handled" != r && "multi" != r) || (Te(n), cr(e)),
      !!r
    );
  }
  function Ko(t, e) {
    ...
    (e.target && e.target != i.display.input.getField()) ||
      ...
      Ce(i, e) ||
        ...
        18 != t ||
          ...
          (D((r = i.display.lineDiv), "CodeMirror-crosshair"),
          ye(document, "keyup", o),
  ...
  function _o(e) {
    ...
    if (
      ...
      var n,
        r = e.keyCode,
        i = e.charCode;
      if (p && r == jo) return (jo = null), void Te(e);
      (p && (!e.which || e.which < 10) && Ko(t, e)) ||
        ("\b" != (i = String.fromCharCode(null == i ? r : i)) &&
          (Uo((n = t), "'" + i + "'", e, function (e) {
            return Bo(n, e, !0);
          }) ||
  ...
  function Qo(e) {
    var t,
      ...
      s = l.display;
    Ce(l, e) ||
      (s.activeTouch && s.input.supportsTouch()) ||
      (s.input.ensurePolled(),
      (s.shift = e.shiftKey),
      mn(s, e)
        ? f ||
          ((s.scroller.draggable = !1),
          setTimeout(function () {
          ...
          (i = t
            ? ((r = t),
              ...
              qo && qo.compare(o, r, i)
                ? (($o = qo = null), "triple")
                : $o && $o.compare(o, r, i)
                ? ((qo = new Zo(o, r, i)), ($o = null), "double")
                : (($o = new Zo(o, r, i)), (qo = null), "single"))
            : "single"),
          window.focus(),
          ...
          (t &&
            (function (n, e, r, t, i) {
              ...
              return Uo(
                ...
                i,
                function (e) {
                  if (("string" == typeof e && (e = Io[e]), !e)) return !1;
                  var t = !1;
                  try {
            ...
            (1 == n
              ? t
                ? (function (e, t, n, r) {
                    w ? setTimeout(F(hr, e), 0) : (e.curOp.focus = A());
                    var i,
                      o = (function (e, t, n) {
                        var r = e.getOption("configureMouse"),
                          i = r ? r(e, t, n) : {};
                        null == i.unit &&
                          ((r = m ? n.shiftKey && n.metaKey : n.altKey),
                          (i.unit = r
                            ? "rectangle"
                            : "single" == t
                            ? "char"
                        ...
                        null == i.addNew &&
                          (i.addNew = g ? n.metaKey : n.ctrlKey);
                        null == i.moveOnDrag &&
                          (i.moveOnDrag = !(g ? n.altKey : n.ctrlKey));
                        return i;
                      })(e, n, r),
                      l = e.doc.sel;
                    (e.options.dragDrop &&
                      ...
                      "single" == n &&
                      -1 < (i = l.contains(t)) &&
                      (it((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) &&
                      (0 < it(i.to(), t) || t.xRel < 0)
                      ? function (t, n, r, i) {
                          var o = t.display,
                            l = !1,
                            s = Er(t, function (e) {
                      ...
                      : function (d, e, f, p) {
                          ...
                          p.addNew && !p.extend
                            ? ((v = g.sel.contains(f)),
                              (m = -1 < v ? t[v] : new oi(f, f)))
                            : ((m = g.sel.primary()), (v = g.sel.primIndex));
                          "rectangle" == p.unit
                            ? (p.addNew || (m = new oi(f, f)),
                              (f = Jn(d, e, !0, !0)),
                              (v = -1))
                            : ((e = Jo(d, f, p.unit)),
                              (m = p.extend
                                ? Oi(m, e.anchor, e.head, p.extend)
                                : e));
                          p.addNew
                            ? -1 == v
                              ? ((v = t.length),
                              ...
                              ? (Pi(
                                  ...
                                  li(
                                    d,
                                    t.slice(0, v).concat(t.slice(v + 1)),
                                    0
                                  ),
                            ...
                            if (0 != it(b, e))
                              if (((b = e), "rectangle" == p.unit)) {
                                ...
                                var h,
                                  ...
                                  e =
                                    0 < it(i.anchor, e)
                                      ? ((h = i.head), at(r.from(), i.anchor))
                                      : ((h = i.anchor), st(r.to(), i.head)),
                                  i = y.ranges.slice(0);
                                (i[v] = (function (e, t) {
                                  var n = t.anchor,
                                    r = t.head,
                                  ...
                                  var i = o[i + (a ? -1 : 0)],
                                    ...
                                    i = a ? i.from : i.to,
                                    a = a ? "after" : "before";
                                  return n.ch == i && n.sticky == a
                                    ? t
                                    : new oi(new rt(n.line, i, a), r);
                                })(d, new oi(ct(g, e), h))),
                                  Pi(g, li(d, i, v), U);
                              }
                          }
                          ...
                          function n(e) {
                            (d.state.selectingText = !1),
                              (u = 1 / 0),
                              e && (Te(e), l.input.focus()),
                              we(l.wrapper.ownerDocument, "mousemove", r),
                              we(l.wrapper.ownerDocument, "mouseup", i),
                ...
                : Ae(e) == s.scroller && Te(e)
              : 2 == n
              ? (t && Ai(l.doc, t),
                setTimeout(function () {
                  return s.input.focus();
                }, 20))
              : 3 == n && (x ? l.display.input.onContextMenu(e) : dr(l)))));
  }
  function Jo(e, t, n) {
  ...
  function el(e, t, n, r) {
    ...
    if (o > r.bottom || !Le(e, n)) return Ne(t);
    o -= r.top - l.viewOffset;
    for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
      var a = l.gutters.childNodes[s];
      if (a && a.getBoundingClientRect().right >= i)
        return (
          xe(e, n, e, et(e.doc, o), e.display.gutterSpecs[s].className, t),
          Ne(t)
        );
    }
  }
  ...
  function nl(e, t) {
    ...
    mn(e.display, t) ||
      ((r = t),
      Le((n = e), "gutterContextMenu") && el(n, r, "gutterContextMenu", !1)) ||
      Ce(e, t, "contextmenu") ||
      x ||
  ...
  function sl(e, t, n) {
    !t != !(n && n != il) &&
      ...
      (t = t ? ye : we)(e.display.scroller, "dragstart", n.start),
  ...
  function al(e) {
    e.options.lineWrapping
      ...
      : (L(e.display.wrapper, "CodeMirror-wrap"), jt(e)),
      Qn(e),
      tr(e),
      Hn(e),
      setTimeout(function () {
  ...
  function ul(e, t) {
    ...
    (this.options = t = t ? P(t) : {}), P(ol, t, !1);
    var r = t.value;
    "string" == typeof r
      ? (r = new ho(r, t.mode, null, t.lineSeparator, t.direction))
      : t.mode && (r.modeOption = t.mode),
      (this.doc = r);
    var i,
      o = new ul.inputStyles[t.inputStyle](this),
      o = (this.display = new Qr(e, r, o, t));
    for (i in (rl((o.wrapper.CodeMirror = this)),
    ...
    (function (r) {
      var i = r.display;
      ye(i.scroller, "mousedown", Er(r, Qo)),
        ye(
          i.scroller,
          "dblclick",
          w && v < 11
            ? Er(r, function (e) {
                ...
                Ce(r, e) ||
                  ...
                  tl(r, e) ||
                  mn(r.display, e) ||
                  (Te(e), (t = r.findWordAt(t)), Ai(r.doc, t.anchor, t.head));
              })
            : function (e) {
                return Ce(r, e) || Te(e);
              }
      ...
      ye(i.scroller, "contextmenu", function (e) {
        ...
        ye(i.input.getField(), "contextmenu", function (e) {
          i.scroller.contains(e.target) || nl(r, e);
        });
      var n,
        o = { end: 0 };
      function l() {
      ...
      ye(i.scroller, "touchstart", function (e) {
        ...
        ye(i.scroller, "touchend", function (e) {
          ...
          n &&
            ...
            ((t = r.coordsChar(i.activeTouch, "page")),
            (t =
              !n.prev || s(n, n.prev)
                ? new oi(t, t)
                : !n.prev.prev || s(n, n.prev.prev)
                ? r.findWordAt(t)
                : new oi(rt(t.line, 0), ct(r.doc, rt(t.line + 1, 0)))),
            r.setSelection(t.anchor, t.head),
            r.focus(),
            Te(e)),
            l();
        }),
        ye(i.scroller, "touchcancel", l),
        ye(i.scroller, "scroll", function () {
          i.scroller.clientHeight &&
            (Lr(r, i.scroller.scrollTop),
        ...
        (i.dragFunctions = {
          ...
          over: function (e) {
            ...
            Ce(r, e) ||
              ((n = Jn((t = r), (n = e))) &&
                (ar(t, n, (n = document.createDocumentFragment())),
          ...
          start: function (e) {
            return (
              (t = r),
              (n = e),
              void (w && (!t.state.draggingText || +new Date() - fo < 100)
                ? Oe(n)
                : Ce(t, n) ||
                  mn(t.display, n) ||
                  (n.dataTransfer.setData("Text", t.getSelection()),
                  (n.dataTransfer.effectAllowed = "copyMove"),
                  n.dataTransfer.setDragImage &&
                    !c &&
                    (((e = M(
                      "img",
                      null,
      ...
      ye(e, "keyup", function (e) {
        ...
        ye(e, "keydown", Er(r, Xo)),
        ye(e, "keypress", Er(r, _o)),
        ye(e, "focus", function (e) {
          return fr(r, e);
        }),
    ...
    vi(this, r),
    (t.autofocus && !h) || this.hasFocus()
      ? setTimeout(function () {
          n.hasFocus() && !n.state.focused && fr(n);
        }, 20)
      : pr(this),
    ll))
      ll.hasOwnProperty(i) && ll[i](this, t[i], il);
    _r(this), t.finishInit && t.finishInit(this);
    for (var l = 0; l < cl.length; ++l) cl[l](this);
    Fr(this),
      f &&
        t.lineWrapping &&
  ...
  function hl(e, t, n, r) {
    ...
    if (r || /\S/.test(s.text)) {
      if (
        "smart" == n &&
        ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == B || 150 < u)
      ) {
        if (!r) return;
        n = "prev";
      }
    ...
    "prev" == n
      ? (u = t > o.first ? E($e(o, t - 1).text, null, l) : 0)
      : "add" == n
      ? (u = a + e.options.indentUnit)
      : "subtract" == n
      ? (u = a - e.options.indentUnit)
      : "number" == typeof n && (u = a + n),
      (u = Math.max(0, u));
    var h = "",
      d = 0;
    if (e.options.indentWithTabs)
      for (var f = Math.floor(u / l); f; --f) (d += l), (h += "\t");
    if ((d < u && (h += X(u - d)), h != c))
      return (
        qi(o, h, rt(t, 0), rt(t, c.length), "+input"), !(s.stateAfter = null)
      );
  ...
  function pl(e, t, n, r, i) {
    ...
    if (s && 1 < r.ranges.length)
      if (dl && dl.text.join("\n") == t) {
        if (r.ranges.length % dl.text.length == 0) {
          u = [];
          for (var c = 0; c < dl.text.length; c++)
            u.push(o.splitLines(dl.text[c]));
        }
      } else
    ...
    for (var h = e.curOp.updateInput, d = r.ranges.length - 1; 0 <= d; d--) {
      ...
      f.empty() &&
        (n && 0 < n
          ...
          ? (g = rt(
              g.line,
              Math.min($e(o, g.line).text.length, g.ch + Y(a).length)
            ))
          : s &&
            dl &&
            dl.lineWise &&
  ...
  function bl() {
    ...
    return (
      f ? (e.style.width = "1000px") : e.setAttribute("wrap", "off"),
      s && (e.style.border = "1px solid black"),
      yl(e),
      t
    );
  }
  function wl(i, o, l, s, a) {
    var e = o,
      t = l,
      u = $e(i, o.line),
    ...
    function n(e) {
      ...
      if (
        ...
        (n =
          "codepoint" == s
            ? ((t = u.text.charCodeAt(o.ch + (0 < s ? 0 : -1))),
              isNaN(t)
                ? null
                : ((n =
                    0 < l ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343),
                  new rt(
                    o.line,
                    Math.max(
                      0,
                      Math.min(u.text.length, o.ch + l * (n ? 2 : 1))
                    ),
                    -l
                  )))
            : a
        ...
        if (
          ...
          return;
        o = Po(a, i.cm, u, o.line, c);
      } else o = n;
      return 1;
    }
    if ("char" == s || "codepoint" == s) n();
    else if ("column" == s) n(!0);
    else if ("word" == s || "group" == s)
      for (
        var r = null,
          h = "group" == s,
          d = i.cm && i.cm.getHelper(o, "wordChars"),
          f = !0;
        !(l < 0) || n(!f);
        f = !1
      ) {
    ...
    for (
      "page" == r
        ? ((i = Math.min(
          ...
          (i = Math.max(i - 0.5 * Yn(e.display), 3)),
  ...
  function Ll(e, t, n) {
    ...
    if (t == e.display.lineDiv) {
      if (!(r = e.display.lineDiv.childNodes[n]))
        return Sl(e.clipPos(rt(e.display.viewTo - 1)), !0);
      (t = null), (n = 0);
    } else
    ...
    for (var i = 0; i < e.display.view.length; i++) {
      ...
      if (o.node == r)
        return (function (u, e, t) {
          ...
          if (s) return Sl(s, r);
          for (
            var a = o.nextSibling, d = i ? i.nodeValue.length - t : 0;
            a;
            a = a.nextSibling
          ) {
            if ((s = l(a, a.firstChild, 0))) return Sl(rt(s.line, s.ch - d), r);
            d += a.textContent.length;
          }
          for (var f = o.previousSibling, p = t; f; f = f.previousSibling) {
            if ((s = l(f, f.firstChild, -1)))
              return Sl(rt(s.line, s.ch + p), r);
  ...
  (e.prototype.init = function (e) {
    ...
    (e.prototype.showPrimarySelection = function () {
      ...
      if (
        ...
        var o = Ll(t, e.anchorNode, e.anchorOffset),
          n = Ll(t, e.focusNode, e.focusOffset);
        if (
          !o ||
          o.bad ||
          !n ||
          ...
          var n = t.display.view,
            l = (r.line >= t.display.viewFrom && Cl(t, r)) || {
          ...
          if (
            (s ||
              (s = {
                node: (u = (u = n[n.length - 1].measure).maps
                  ? u.maps[u.maps.length - 1]
                  : u.map)[u.length - 1],
            ...
            a &&
              (!d && t.state.focused
                ? (e.collapse(l.node, l.offset),
                  a.collapsed || (e.removeAllRanges(), e.addRange(a)))
    ...
    (e.prototype.pollSelection = function () {
      if (
        ...
        this.composing ||
          (this.rememberSelection(),
          (e = Ll(r, n.anchorNode, n.anchorOffset)),
          (t = Ll(r, n.focusNode, n.focusOffset)),
          e &&
            t &&
            Pr(r, function () {
              Pi(r.doc, si(e, t), G),
    ...
    (e.prototype.pollContent = function () {
      ...
      if (
        (0 == i.ch &&
          i.line > t.firstLine() &&
          (i = rt(i.line - 1, $e(t.doc, i.line - 1).length)),
        r.ch == $e(t.doc, r.line).text.length &&
          r.line < t.lastLine() &&
          (r = rt(r.line + 1, 0)),
        ...
        return !1;
      m =
        i.line == n.viewFrom || 0 == (m = er(t, i.line))
          ? ((e = Je(n.view[0].line)), n.view[0].node)
          : ((e = Je(n.view[m].line)), n.view[m - 1].node.nextSibling);
      var o,
        r = er(t, r.line),
        r =
          r == n.view.length - 1
            ? ((o = n.viewTo - 1), n.lineDiv.lastChild)
            : ((o = Je(n.view[r + 1].line) - 1),
              n.view[r + 1].node.previousSibling);
      if (!m) return !1;
      for (
        var l = t.doc.splitLines(
            (function (l, e, t, s, a) {
              var n = "",
                u = !1,
          ...
          s = qe(t.doc, rt(e, 0), rt(o, $e(t.doc, o).text.length));
        1 < l.length && 1 < s.length;

      )
        if (Y(l) == Y(s)) l.pop(), s.pop(), o--;
        else {
          if (l[0] != s[0]) break;
          l.shift(), s.shift(), e++;
        }
      for (
        var a = 0, u = 0, c = l[0], h = s[0], d = Math.min(c.length, h.length);
        a < d && c.charCodeAt(a) == h.charCodeAt(a);
      ...
      for (
        var f = Y(l),
          p = Y(s),
          g = Math.min(
            f.length - (1 == l.length ? a : 0),
            p.length - (1 == s.length ? a : 0)
          );
        u < g &&
        f.charCodeAt(f.length - u - 1) == p.charCodeAt(p.length - u - 1);
      ...
      if (1 == l.length && 1 == s.length && e == i.line)
        for (
          ...
          a--, u++;
      (l[l.length - 1] = f.slice(0, f.length - u).replace(/^\u200b+/, "")),
        (l[0] = l[0].slice(a).replace(/\u200b+$/, ""));
      var m = rt(e, a),
        r = rt(o, s.length ? Y(s).length - u : 0);
      return 1 < l.length || l[0] || it(m, r)
        ? (qi(t.doc, l, m, r, "+input"), !0)
        : void 0;
    }),
  ...
  (r.prototype.init = function (n) {
    ...
    function t(e) {
      if (!Ce(i, e)) {
        if (i.somethingSelected())
          fl({ lineWise: !1, text: i.getSelections() });
        else {
    ...
    n.wrapper.insertBefore(this.wrapper, n.wrapper.firstChild),
      ...
      ye(o, "cut", t),
      ye(o, "copy", t),
      ye(n.scroller, "paste", function (e) {
        if (!mn(n, e) && !Ce(i, e)) {
          if (!o.dispatchEvent)
    ...
    (r.prototype.prepareSelection = function () {
      ...
      return (
        t.options.moveInputWithCursor &&
          ((e = Bn(t, r.sel.primary().head, "div")),
          (t = n.wrapper.getBoundingClientRect()),
          (r = n.lineDiv.getBoundingClientRect()),
          (i.teTop = Math.max(
            0,
            Math.min(n.wrapper.clientHeight - 10, e.top + r.top - t.top)
          )),
          (i.teLeft = Math.max(
            0,
            Math.min(n.wrapper.clientWidth - 10, e.left + r.left - t.left)
          ))),
        i
      );
    }),
    ...
    (r.prototype.onContextMenu = function (e) {
      ...
      function h() {
        ...
        null != o.selectionStart &&
          ((t = "​" + ((e = r.somethingSelected()) ? o.value : "")),
          (o.value = "⇚"),
          (o.value = t),
          (n.prevInput = e ? "" : "​"),
          (o.selectionStart = 1),
      ...
      u &&
        ...
        (r.options.resetSelectionOnContextMenu &&
          -1 == r.doc.sel.contains(u) &&
          Er(r, Pi)(r.doc, si(u), G),
        (l = o.style.cssText),
    ...
    Al("lineSeparator", null, function (e, r) {
      if ((e.doc.lineSep = r)) {
        var i = [],
          o = e.doc.first;
        e.doc.iter(function (e) {
        ...
        for (var t = i.length - 1; 0 <= t; t--)
          qi(e.doc, r, i[t], rt(i[t].line, i[t].ch + r.length));
      }
    }),
    Al(
      "specialChars",
    ...
    Al("rtlMoveVisually", !y),
    Al("wholeLineUpdateBefore", !0),
    Al(
      "theme",
      "default",
      function (e) {
    ...
    Al("keyMap", "default", function (e, t, n) {
      (t = Do(t)), (n = n != il && Do(n));
      n && n.detach && n.detach(e, t), t.attach && t.attach(e, n || null);
    }),
    Al("extraKeys", null),
    Al("configureMouse", null),
    Al("lineWrapping", !1, al, !0),
    Al(
      "gutters",
      [],
      function (e, t) {
    ...
    Al("showCursorWhenSelecting", !1, lr, !0),
    Al("resetSelectionOnContextMenu", !0),
    Al("lineWiseCopyCut", !0),
    Al("pasteLinesPerSelection", !0),
    Al("selectionsMayTouch", !1),
    Al("readOnly", !1, function (e, t) {
      "nocursor" == t && (pr(e), e.display.input.blur()),
        e.display.input.readOnlyChanged(t);
    }),
    Al("screenReaderLabel", null, function (e, t) {
    ...
    Al("dragDrop", !0, sl),
    Al("allowDropFileTypes", null),
    Al("cursorBlinkRate", 530),
    Al("cursorScrollMargin", 0),
    Al("cursorHeight", 1, lr, !0),
    Al("singleCursorHeightPerLine", !0, lr, !0),
    Al("workTime", 100),
    Al("workDelay", 100),
    Al("flattenSpans", !0, fi, !0),
    Al("addModeClass", !1, fi, !0),
    Al("pollInterval", 100),
    Al("undoDepth", 200, function (e, t) {
      return (e.doc.history.undoDepth = t);
    }),
    Al("historyEventDelay", 1250),
    Al(
      "viewportMargin",
      10,
      function (e) {
    ...
    Al("maxHighlightLength", 1e4, fi, !0),
    Al("moveInputWithCursor", !0, function (e, t) {
    ...
    (Ml.prototype = {
      ...
      setOption: function (e, t) {
        ...
        (n[e] == t && "mode" != e) ||
          ((n[e] = t),
          Nl.hasOwnProperty(e) && Er(this, Nl[e])(this, t, r),
      ...
      addKeyMap: function (e, t) {
        this.state.keyMaps[t ? "push" : "unshift"](Do(e));
      },
      ...
      addOverlay: Ir(function (e, t) {
        var n = e.token ? e : Ml.getMode(this.options, e);
      ...
      removeOverlay: Ir(function (e) {
        for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
          ...
          if (r == e || ("string" == typeof e && r.name == e))
            return t.splice(n, 1), this.state.modeGen++, void tr(this);
        }
      }),
      ...
      getModeAt: function (e) {
        var t = this.doc.mode;
        return t.innerMode ? Ml.innerMode(t, this.getTokenAt(e).state).mode : t;
      },
      ...
      coordsChar: function (e, t) {
        return Vn(this, (e = Rn(this, e, t || "page")).left, e.top);
      },
      lineAtHeight: function (e, t) {
        return (
          (e = Rn(this, { top: e, left: 0 }, t || "page").top),
        ...
        var r,
          ...
          e =
            "number" == typeof e
              ...
              : e;
        return (
          In(this, e, { top: 0, left: 0 }, t || "page", n || i).top +
          (i ? this.doc.height - Vt(e) : 0)
        );
      },
      ...
      addWidget: function (e, t, n, r, i) {
        var o,
          l,
          s = this.display,
          a = (e = Bn(this, ct(this.doc, e))).bottom,
          u = e.left;
        (t.style.position = "absolute"),
          ...
          "over" == r
            ? (a = e.top)
            : ("above" != r && "near" != r) ||
              ((o = Math.max(s.wrapper.clientHeight, this.doc.height)),
              (l = Math.max(s.sizer.clientWidth, s.lineSpace.clientWidth)),
              ("above" == r || e.bottom + t.offsetHeight > o) &&
              e.top > t.offsetHeight
                ? (a = e.top - t.offsetHeight)
                : e.bottom + t.offsetHeight <= o && (a = e.bottom),
      ...
      triggerOnKeyDown: Ir(Xo),
      triggerOnKeyPress: Ir(_o),
      triggerOnKeyUp: Yo,
      triggerOnMouseDown: Ir(Qo),
      ...
      findPosH: function (e, t, n, r) {
        ...
        t < 0 && ((i = -1), (t = -t));
        for (
          var o = ct(this.doc, e), l = 0;
          l < t && !(o = wl(this.doc, o, i, n, r)).hitSide;
          ++l
        );
        return o;
      },
      moveH: Ir(function (t, n) {
        ...
        this.extendSelectionsBy(function (e) {
          return r.display.shift || r.doc.extend || e.empty()
            ? wl(r.doc, e.head, t, n, r.options.rtlMoveVisually)
            : t < 0
            ? e.from()
            : e.to();
        }, V);
      ...
      toggleOverwrite: function (e) {
        (null != e && e == this.state.overwrite) ||
          (((this.state.overwrite = !this.state.overwrite) ? D : L)(
      ...
      scrollIntoView: Ir(function (e, t) {
        ...
        null == e
          ...
          (e.margin = t || 0),
          null != e.from.line
            ? ((n = e), Cr((t = this)), (t.curOp.scrollToPos = n))
            : Sr(this, e.from, e.to, e.margin);
      }),
      ...
      refresh: Ir(function () {
        ...
        tr(this),
          ...
          jr(this.display),
          (null == e ||
            0.5 < Math.abs(e - Yn(this.display)) ||
    ...
    ke(Ml),
    (Ml.registerHelper = function (e, t, n) {
      Ol.hasOwnProperty(e) || (Ol[e] = Ml[e] = { _global: [] }), (Ol[e][t] = n);
    }),
    (Ml.registerGlobalHelper = function (e, t, n, r) {
      Ml.registerHelper(e, t, r), Ol[e]._global.push({ pred: n, val: r });
    });
  var Dl,
    Wl,
    Hl = "iter insert remove copy getEditor constructor".split(" ");
  for (Dl in ho.prototype)
    ho.prototype.hasOwnProperty(Dl) &&
      R(Hl, Dl) < 0 &&
      (ul.prototype[Dl] = (function (e) {
        return function () {
  ...
  return (
    ke(ho),
    (ul.inputStyles = { textarea: r, contenteditable: e }),
    (ul.defineMode = function (e) {
      ul.defaults.mode || "null" == e || (ul.defaults.mode = e),
        function (e, t) {
          2 < arguments.length &&
    ...
    ul.defineMIME("text/  ", "null"),
    (ul.defineExtension = function (e, t) {
      ul.prototype[e] = t;
    }),
    (ul.defineDocExtension = function (e, t) {
      ho.prototype[e] = t;
    }),
    (ul.fromTextArea = function (t, n) {
      var e;
      function r() {
        t.value = s.getValue();
      }
      if (
        ...
        t.form && (ye(t.form, "submit", r), !n.leaveSubmitMethodAlone))
      ) {
        var i = t.form,
          o = i.submit;
        try {
    ...
    (Wl.isModifierKey = No),
    (Wl.lookupKey = Mo),
    (Wl.normalizeKeyMap = To),
    (Wl.StringStream = _e),
    (Wl.SharedTextMarker = ao),
    (Wl.TextMarker = lo),
    (Wl.LineWidget = ro),
    (Wl.e_preventDefault = Te),
    (Wl.e_stopPropagation = Me),
    (Wl.e_stop = Oe),
    (Wl.addClass = D),
    (Wl.contains = O),
    (Wl.rmClass = L),
